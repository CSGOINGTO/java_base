...
class SecurityManager {
    ...
    private static java.lang.ThreadGroup rootGroup = getRootGroup();

    private static java.lang.ThreadGroup getRootGroup() {
        java.lang.ThreadGroup root =  java.lang.Thread.currentThread().getThreadGroup();
     ...
     * @see        java.lang.Thread#setName(String) setName
     ...
     * @see        AccessControlContext#checkPermission(Permission)
     */
    public void checkRead(String file, java.lang.Object context) {
        checkPermission(
     ...
     * @see        AccessControlContext#checkPermission(Permission)
     */
    public void checkConnect(String host, int port, java.lang.Object context) {
        if (host == null) {
            throw new NullPointerException("host can't be null");
        }
        if (!host.startsWith("[") && host.indexOf(':') != -1) {
    ...
    private static final java.lang.Object packageAccessLock = new java.lang.Object();

    private static boolean packageDefinitionValid = false;
    private static String[] packageDefinition;
    private static final java.lang.Object packageDefinitionLock = new java.lang.Object();
