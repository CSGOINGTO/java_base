...
//                b.interrupt(this); 源码未注释
     ...
     * @throws SecurityException if {@link ThreadGroup#checkAccess} determines that
...
//            security.checkAccess(this);
    ...
    public ClassLoader getContextClassLoader() {
        ...
        if (sm != null) {
//            ClassLoader.checkClassLoaderPermission(contextClassLoader, Reflection.getCallerClass()); 源码未注释
        }
